...
## What to Preserve
- Author's unique voice and opinion
- Concrete examples, data, and specific references
- Section structure driven by topic logic (not templates)
- Quotes and attributed material

## Rhythm Targets
| Parameter | Value |
|----------|-------|
| Fragment spacing | 1-2 per 100 words (qualitative — use feel, not counting) |
| Conjunction spacing | 2-4 per 100 words (qualitative target) |
| Max consecutive same category | 2 |

Additional targets: short sentences every 3-5 sentences. Sentence length: high variance (fragment to 3-clause). Paragraphs: varied visual weight (light/medium/heavy mix).
